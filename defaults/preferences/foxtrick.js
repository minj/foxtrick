pref( "extensions.foxtrick.prefs.curVersion", "0.4.6.3");   // update with each release
pref( "extensions.foxtrick.prefs.oldVersion", "0.4.6.2");   // don't change!! (unless you know what you do). 
