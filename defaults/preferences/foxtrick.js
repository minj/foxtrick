pref( "extensions.foxtrick.prefs.curVersion", "0.5.1.0rc1");   // update with each release
...
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Player.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Age.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Keeper.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Defending.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Playmaking.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Winger.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Passing.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Scoring.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Set_pieces.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Yellow_card.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Red_card.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Bruised.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Injured.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Speciality.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Last_stars.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.own.Last_position.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Player.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Age.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Yellow_card.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Red_card.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Bruised.enabled", true );
pref( "extensions.foxtrick.prefs.module.YouthSkillTable.other.Injured.enabled", true );
