...
var FoxtrickLinksCustom = {
		...
		try { 
			...
			for (key in keys)  { 
				...
				try { // add icons
					...
					div.innerHTML="<img src='chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/transparent16.png'>";
	...
	showEdit : function( doc , ownBoxBody, basepref) {
		try { 			
			...
			divn.innerHTML="<img src='chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/transparent16.png'>";
			...
			div.innerHTML="<img id='inputImgIDName' src='chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/aiga.png'>";
			div.imgref='chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/aiga.png';
			div.setAttribute("style","display:inline-block; width: 16; height: 16px; background: url('chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/empty16.png') 50% no-repeat;");
			...
			helplink.innerHTML="<img src='chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/transparent16.png'>";
	...
	editOldLink : function (evt) { 
		try {
			...
			doc.getElementById("inputImgDivID").setAttribute("style","cursor:pointer; display:inline-block; width: 16; height: 16px; background: url('chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/linkicons/ownicons/"+FoxtrickPrefs.getString(baseprefnl+'.img')+"') 50% no-repeat;");
