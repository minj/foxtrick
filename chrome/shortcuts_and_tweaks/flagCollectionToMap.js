...
FoxtrickFlagCollectionToMap = {
	...
	getMapFixWorld : function(countryIds) {
		...
		for(var i = 0; i < countryIds.length; i++){
            ...
            if(ukIds != 4) {  //only if not added before
                if (countryId == 61) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_gb_cy.png"> ';}
                if (countryId == 2) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;"src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_gb_en.png"> ';}
                if (countryId == 93) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_gb_nie.png"> ';}
                if (countryId == 26) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_gb_sc.png"> ';}
			}
            // yu hack
			if(yuIds != 2) {
                if (countryId == 57) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_rs.png"> ';}
                if (countryId == 131) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_world_me.png">';}
            }
        }
        return cImgString;
    },
	...
	getMapFixEurope : function(countryIds) {
		...
		for(var i = 0; i < countryIds.length; i++){
            ...
            // uk hack
            if(ukIds != 4) {  //only if not added before
                if (countryId == 61) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_gb_cy.png"> ';}
                if (countryId == 2) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;"src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_gb_en.png"> ';}
                if (countryId == 93) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_gb_nie.png"> ';}
                if (countryId == 26) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_gb_sc.png"> ';}
			}
            // yu hack
			if(yuIds != 2) {
                if (countryId == 57) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_rs.png"> ';}
                if (countryId == 131) {offset-=220; cImgString+='<img style="margin-top:'+offset+'px;" src="chrome-extension://bpfbbngccefbbndginomofgpagkjckik/resources/img/maps/chart_europe_me.png">';}
            }
        }
        return cImgString;
    },
