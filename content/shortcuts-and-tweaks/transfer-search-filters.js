...
Foxtrick.modules['TransferSearchFilters'] = {
    ...
    run: function(doc) {
        ...
        var backwardCompatibleCodes = {
            ...
            _60: FTPRE + 'hideHead.check',
            _61: FTPRE + 'hideQuick.check',
            _62: FTPRE + 'hideTechnical.check',
            _63: FTPRE + 'hideUnpredictable.check',
            _64: FTPRE + 'hidePowerful.check',
            _65: FTPRE + 'hideRegainer.check'
