...
Foxtrick.modules["CopyPlayerAd"]={
	...
	run : function(doc) {
		...
		var button = Foxtrick.util.copyButton.add(doc,
			Foxtrickl10n.getString("copy.copyplayerad"));
		if (button) {
	...
	createPlayerAd : function(ev) {
		...
		try {
			...
			var note = Foxtrick.util.note.add(doc, insertBefore, "ft-playerad-copy-note", Foxtrickl10n.getString("copy.copied"), null, true);
		}
		catch (e) {
