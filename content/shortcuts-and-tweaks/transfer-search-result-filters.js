...
Foxtrick.modules['TransferSearchResultFilters'] = {
    ...
    run: function(doc) {
        ...
        var FILTER_FUNC = {
            ...
            'hideOrdinary': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 0);
            },
            'hideTechnical': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 1);
            },
            'hideQuick': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 2);
            },
            'hidePowerful': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 3);
            },
            'hideUnpredictable': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 4);
            },
            'hideHead': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 5);
            },
            'hideRegainer': function(player, checked) {
                if (player.speciality == null)
                    return true;
                return (player.specialityNumber == 6);
            }
        };
        ...
        var FILTER_VAL = [
            ...
            { key: 'hideHead', type: 'check', checked: false },
            { key: 'hideQuick', type: 'check', checked: false },
            { key: 'hideTechnical', type: 'check', checked: false },
            { key: 'hideUnpredictable', type: 'check', checked: false },
            { key: 'hidePowerful', type: 'check', checked: false },
            { key: 'hideRegainer', type: 'check', checked: false }
        ];
