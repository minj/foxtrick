...
FoxtrickFirefox.prototype = {
	loadScript: function() {
		...
		Services.scriptloader.loadSubScript("chrome://foxtrick/content/util/cookies.js",this.owner, "UTF-8");
		...
		Services.scriptloader.loadSubScript("chrome://foxtrick/content/lib/js-yaml.js",this.owner, "UTF-8");
