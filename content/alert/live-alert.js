...
Foxtrick.modules["LiveAlert"].store = {};

Foxtrick.modules["LiveAlert"].run = function(doc) {
	this.alert(doc);
};

Foxtrick.modules["LiveAlert"].change = function(doc) {
	this.alert(doc);
};

Foxtrick.modules["LiveAlert"].getScoreFromTab = function(tab) {
	try {
...
Foxtrick.modules["LiveAlert"].getTeamsFromTab = function(tab) {
...
Foxtrick.modules["LiveAlert"].alert = function(doc) {
