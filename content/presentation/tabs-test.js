Foxtrick.modules["TabsTest"]={
	...
	nightly: "You are a nightly user, found a bug? Report it please. If you don't know where to report you shouldn't use this version.",
	run : function(doc) {
		...
		Foxtrick.util.tabs.add(doc, "Read me", { alt: "Ipsum", title: "Ipsum", src: "/Img/Icons/cross_small.png"} , "ft-tab-nightly");
		...
		div3.setAttribute("id", "ft-tab-nightly");
