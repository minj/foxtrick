Foxtrick.modules["TabsTest"]={
	...
	nightly: "You are a nighly user, found a bug? Report it please. If you don't know where to report you shouldn't use this version.",
	run : function(doc) {
		...
		Foxtrick.util.tabs.add(doc, "Nightly", { alt: "Ipsum", title: "Ipsum", src: "/Img/Icons/cross_small.png"} , "ft-tab-nightly");
