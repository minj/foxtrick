...
Foxtrick.modules['EmbedMediaHTPress'] = {
	...
	run: function(doc) {
		...
		var article = doc.getElementById('ctl00_ctl00_CPContent_CPMain_pnlSpecificArticle');

		var found_media_links = getSupportedMediaLinksWithDetails(article);
