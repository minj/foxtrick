...
Foxtrick.modules["FlagCollectionToMap"]={
	...
	HT_countries : {
		...
		36	:	['ES'],	// Espana
		76	:	['FO'],	// Foroyar
		5	:	['FR','GF','TF','BL','GP','MF','MQ','NC','PF','PM','RE','WF','YT'],	// France  PF part of oceania?
		137	:	['GH'],	// Ghana
		107	:	['GT'],	// Guatemala
		30	:	['KR'],	// Hanguk
		122	:	['AM'],	// Hayastan
		...
		22	:	['JP'],	// Nippon
		9	:	['NO','SJ'],	// Norge
		15	:	['AU','NZ','CX','CC','NF','FJ','NC','PG','SB','VU','FM','GU','KI','MH','NR','MP','PW','AS','CK','PF','NU','PN','WS','TK','TO','TV','WF'],	// Oceania
		134	:	['OM'],	// Oman
		39	:	['AT'],	// Österreich
		71	:	['PK'],	// Pakistan
		96	:	['PA'],	// Panamá
	...
	createAndInsertMap : function(document, countryIdsHasFlags, mapId, parent, insertBefore) {
		...
		var urlAsia = this.getMapUrl(Asia, collectedCountryCodes, colouringOrder,'-50,40,70,180','440x530');
		var urlEurope = this.getMapUrl(Europe, collectedCountryCodes, colouringOrder,'34,-11,64,30','440x540');
		var urlMEast = this.getMapUrl(MEast, collectedCountryCodes, colouringOrder,'12,24,44,64','440x440');
		var urlSAmerica = this.getMapUrl(SAmerica, collectedCountryCodes, colouringOrder,'-55,-95,25,-30','440x640');
		var urlWorld = this.getMapUrl(World, collectedCountryCodes, colouringOrder,'-60,-180,80,180','440x300');
