...
Foxtrick.modules['MatchWeather'] = {
	...
	showWeather: function(doc, data) {
		...
		var expectedText = Foxtrickl10n.getString('matchWeather.expected');
		var todayText = Foxtrickl10n.getString('matchWeather.today');
		var tomorrowText = Foxtrickl10n.getString('matchWeather.tomorrow');
		var irlNowText = Foxtrickl10n.getString('matchWeather.irltoday');
		var irlTomorrowText = Foxtrickl10n.getString('matchWeather.irltomorrow');
