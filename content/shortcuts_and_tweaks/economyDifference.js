...
var FoxtrickEconomyDifference = {
    ...
    run : function( page, doc ) {
		...
		var zaw = "#divfoxtrick_eD_heading .tblBox {background: url('chrome://foxtrick/content/resources/img/down.gif') 413px 0 no-repeat;padding-right:20px;}";
		if (Foxtrick.isStandardLayout(doc) )
			zaw="#divfoxtrick_eD_heading .tblBox {background: url('chrome://foxtrick/content/resources/img/link-down.png') #999999 505px 4px no-repeat;padding-right:20px;}";			
