 ...
 */
 ...
 var FoxtrickForumYouthIcons = {
    ...
    run : function( page, doc ) {
        ...
        if (page == 'guestbook' ) 
            try {
                var textbox = doc.getElementById( "ctl00_CPMain_txtInsert" );
    ...
    _youthplayer : function (  ) {
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[youthplayerid=xxx]", null, "xxx", null)
    ...
    _youthteam : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[youthteamid=xxx]", null, "xxx", null)
    ...
    _youthmatch : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[youthmatchid=xxx]", null, "xxx", null)
    ...
    _youthseries : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[youthleagueid=xxx]", null, "xxx", null)
    ...
    _userid : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[userid=xxx]", null, "xxx", null)
    ...
    _kitid : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[kitid=xxx]", null, "xxx", null)
    ...
    _articleid : function (  ) { 
        if ( FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody') != null ) clickHandler(FoxtrickForumYouthIcons._DOC.getElementById('ucHattrickMLEditor_txtBody'), "[articleid=xxx]", null, "xxx", null)
