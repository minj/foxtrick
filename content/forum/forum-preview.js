	...
	run : function(doc) {
		var preview = function() {
			var singleReplace = [
				...
				[/\[tournamentmatchid=(\d+)\]/gi, "<a href=\"/Club/Matches/Match.aspx?matchID=$1&SourceSystem=HTOIntegrated\" target=\"_blank\">($1)</a>"],
				...
				[/\[tournamentid=(\d+)\]/gi, "<a href=\"/Community/Tournaments/Tournament.aspx?tournamentId=$1\" target=\"_blank\">($1)</a>"],
