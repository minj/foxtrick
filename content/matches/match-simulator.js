...
Foxtrick.modules["MatchSimulator"].run = function(doc) {
	var MatchTypes = {
		...
		"6":{className:"", title:"Not currently in use, but reserved for international competition matches with normal rules (may or may not be implemented at some future point)."},
					...
					var getMatchDetails = function(selectedMatchid, SourceSystem, homeAway, isNew) {
						...
						function(selectedMatchXML, errorText) {
							...
							if (isNew) { 
								...
								option.className = "ftOptionIcon " + MatchTypes[MatchType].className;
