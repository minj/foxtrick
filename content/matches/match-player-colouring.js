...
Foxtrick.modules["MatchPlayerColouring"].run = function(doc) {
...
Foxtrick.modules["MatchPlayerColouring"].change = function(doc) {
	if (Foxtrick.isPage("playerdetail", doc))
		this.addHighlightParam(doc);
};

// add match report highlight links to playerdetails
Foxtrick.modules["MatchPlayerColouring"].addHighlightParam = function(doc) {
...
Foxtrick.modules["MatchPlayerColouring"].color = function(doc) {
