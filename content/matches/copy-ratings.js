...
Foxtrick.modules['CopyRatings'] = {
	...
	copyRatingDetails: function(doc) {
		...
		var SECTORS_TEMPLATE =
			'[tr][th colspan=3 align=center]{sectors_title}[/th][/tr]\n' +
		...
		var TEMPLATE =
			...
			// '[tr][td align=center]{home_atd}[/td]' +
			// '[th align=center]{attitude_lbl}[/th]' +
			// '[td align=center]{away_atd}[/td][/tr]\n' +
			'[tr][td align=center][u]{home_tct_txt}[/u][/td]' +
			'[th align=center]{tactic_lbl}[/th]' +
			'[td align=center][u]{away_tct_txt}[/u][/td][/tr]\n' +
			'[tr][td align=center]{home_tct_lvl}[/td]' +
			'[th align=center]{tactic_lvl_lbl}[/th]' +
			'[td align=center]{away_tct_lvl}[/td][/tr]\n' +
			'{sectors}\n[/table]\n';
