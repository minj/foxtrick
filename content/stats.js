...
Foxtrick.LinkCollection.countryid_to_leagueid = {};
...
countryflags[102]={'flag':'-2040px 0','name':'Kyrgyzstan'};
countryflags[103]={'flag':'-2060px 0','name':'Moldova'};
countryflags[104]={'flag':'-2080px 0','name':'Sakartvelo'};
countryflags[105]={'flag':'-2100px 0','name':'Andorra'};
countryflags[106]={'flag':'-2120px 0','name':'Al Urdun'};
countryflags[107]={'flag':'-2140px 0','name':'Guatemala'};
countryflags[11]={'flag':'-220px 0','name':'Danmark'};
countryflags[110]={'flag':'-2200px 0','name':'Trinidad & Tobago'};
countryflags[111]={'flag':'-2220px 0','name':'Nicaragua'};
countryflags[112]={'flag':'-2240px 0','name':'Kazakhstan'};
countryflags[113]={'flag':'-2260px 0','name':'Suriname'};
countryflags[117]={'flag':'-2340px 0','name':'Liechtenstein'};
countryflags[118]={'flag':'-2360px 0','name':'Algérie'};
countryflags[119]={'flag':'-2380px 0','name':'Mongol Uls'};
countryflags[12]={'flag':'-240px 0','name':'Suomi'};
countryflags[120]={'flag':'-2400px 0','name':'Lubnan'};
countryflags[121]={'flag':'-2420px 0','name':'Sénégal'};
countryflags[122]={'flag':'-2440px 0','name':'Hayastan'};
countryflags[123]={'flag':'-2460px 0','name':'Bahrain'};
countryflags[124]={'flag':'-2480px 0','name':'Barbados'};
countryflags[125]={'flag':'-2500px 0','name':'Cabo Verde'};
countryflags[126]={'flag':'-2520px 0','name':'Côte d’Ivoire'};
countryflags[127]={'flag':'-2540px 0','name':'Al Kuwayt'};
countryflags[128]={'flag':'-2560px 0','name':'Al Iraq'};
countryflags[129]={'flag':'-2580px 0','name':'Az?rbaycan'};
countryflags[130]={'flag':'-2600px 0','name':'Angola'};
countryflags[131]={'flag':'-2620px 0','name':'Crna Gora'};
countryflags[132]={'flag':'-2640px 0','name':'Bangladesh'};
countryflags[133]={'flag':'-2660px 0','name':'Al Yaman'};
countryflags[134]={'flag':'-2680px 0','name':'Oman'};
countryflags[135]={'flag':'-2700px 0','name':'Moçambique'};
countryflags[136]={'flag':'-2720px 0','name':'Brunei'};
countryflags[137]={'flag':'-2740px 0','name':'Ghana'};
countryflags[138]={'flag':'-2760px 0','name':'Kampuchea'};
countryflags[139]={'flag':'-2780px 0','name':'Benin'};
countryflags[14]={'flag':'-280px 0','name':'Nederland'};
countryflags[140]={'flag':'-2800px 0','name':'Suriyah'};
countryflags[141]={'flag':'-2820px 0','name':'Dawlat Qatar'};
countryflags[142]={'flag':'-2840px 0','name':'Tanzania'};
countryflags[143]={'flag':'-2860px 0','name':'Uganda'};
countryflags[144]={'flag':'-2880px 0','name':'Dhivehi Raajje'};
countryflags[15]={'flag':'-300px 0','name':'Oceania'};
countryflags[16]={'flag':'-320px 0','name':'Brasil'};
countryflags[17]={'flag':'-340px 0','name':'Canada'};
countryflags[18]={'flag':'-360px 0','name':'Chile'};
countryflags[19]={'flag':'-380px 0','name':'Colombia'};
countryflags[2]={'flag':'-40px 0','name':'England'};
countryflags[20]={'flag':'-400px 0','name':'India'};
countryflags[21]={'flag':'-420px 0','name':'Ireland'};
countryflags[22]={'flag':'-440px 0','name':'Nippon'};
countryflags[23]={'flag':'-460px 0','name':'Perú'};
countryflags[24]={'flag':'-480px 0','name':'Polska'};
countryflags[25]={'flag':'-500px 0','name':'Portugal'};
countryflags[26]={'flag':'-520px 0','name':'Scotland'};
countryflags[27]={'flag':'-540px 0','name':'South Africa'};
countryflags[28]={'flag':'-560px 0','name':'Uruguay'};
countryflags[29]={'flag':'-580px 0','name':'Venezuela'};
countryflags[3]={'flag':'-60px 0','name':'Deutschland'};
countryflags[30]={'flag':'-600px 0','name':'Hanguk'};
countryflags[31]={'flag':'-620px 0','name':'Prathet Thai'};
countryflags[32]={'flag':'-640px 0','name':'Türkiye'};
countryflags[33]={'flag':'-660px 0','name':'Misr'};
countryflags[34]={'flag':'-680px 0','name':'China'};
countryflags[35]={'flag':'-700px 0','name':'Rossiya'};
countryflags[36]={'flag':'-720px 0','name':'España'};
countryflags[37]={'flag':'-740px 0','name':'România'};
countryflags[38]={'flag':'-760px 0','name':'Ísland'};
countryflags[39]={'flag':'-780px 0','name':'Österreich'};
countryflags[4]={'flag':'-80px 0','name':'Italia'};
countryflags[44]={'flag':'-880px 0','name':'België'};
countryflags[45]={'flag':'-900px 0','name':'Malaysia'};
countryflags[46]={'flag':'-920px 0','name':'Schweiz'};
countryflags[47]={'flag':'-940px 0','name':'Singapore'};
countryflags[5]={'flag':'-100px 0','name':'France'};
countryflags[50]={'flag':'-1000px 0','name':'Hellas'};
countryflags[51]={'flag':'-1020px 0','name':'Magyarország'};
countryflags[52]={'flag':'-1040px 0','name':'Ceská republika'};
countryflags[53]={'flag':'-1060px 0','name':'Latvija'};
countryflags[54]={'flag':'-1080px 0','name':'Indonesia'};
countryflags[55]={'flag':'-1100px 0','name':'Philippines'};
countryflags[56]={'flag':'-1120px 0','name':'Eesti'};
countryflags[57]={'flag':'-1140px 0','name':'Srbija'};
countryflags[58]={'flag':'-1160px 0','name':'Hrvatska'};
countryflags[59]={'flag':'-1180px 0','name':'Hong Kong'};
countryflags[6]={'flag':'-120px 0','name':'México'};
countryflags[60]={'flag':'-1200px 0','name':'Chinese Taipei'};
countryflags[61]={'flag':'-1220px 0','name':'Cymru'};
countryflags[62]={'flag':'-1240px 0','name':'Bulgaria'};
countryflags[63]={'flag':'-1260px 0','name':'Israel'};
countryflags[64]={'flag':'-1280px 0','name':'Slovenija'};
countryflags[66]={'flag':'-1320px 0','name':'Lietuva'};
countryflags[67]={'flag':'-1340px 0','name':'Slovensko'};
countryflags[68]={'flag':'-1360px 0','name':'Ukraina'};
countryflags[69]={'flag':'-1380px 0','name':'Bosna i Hercegovina'};
countryflags[7]={'flag':'-140px 0','name':'Argentina'};
countryflags[70]={'flag':'-1400px 0','name':'Vietnam'};
countryflags[71]={'flag':'-1420px 0','name':'Pakistan'};
countryflags[72]={'flag':'-1440px 0','name':'Paraguay'};
countryflags[73]={'flag':'-1460px 0','name':'Ecuador'};
countryflags[74]={'flag':'-1480px 0','name':'Bolivia'};
countryflags[75]={'flag':'-1500px 0','name':'Nigeria'};
countryflags[76]={'flag':'-1520px 0','name':'Føroyar'};
countryflags[77]={'flag':'-1540px 0','name':'Al Maghrib'};
countryflags[79]={'flag':'-1580px 0','name':'Saudi Arabia'};
countryflags[8]={'flag':'-160px 0','name':'USA'};
countryflags[80]={'flag':'-1600px 0','name':'Tounes'};
countryflags[81]={'flag':'-1620px 0','name':'Costa Rica'};
countryflags[83]={'flag':'-1660px 0','name':'United Arab Emirates'};
countryflags[84]={'flag':'-1680px 0','name':'Lëtzebuerg'};
countryflags[85]={'flag':'-1700px 0','name':'Iran'};
countryflags[88]={'flag':'-1760px 0','name':'Republica Dominicana'};
countryflags[89]={'flag':'-1780px 0','name':'Cyprus'};
countryflags[9]={'flag':'-180px 0','name':'Norge'};
countryflags[91]={'flag':'-1820px 0','name':'Belarus'};
countryflags[93]={'flag':'-1860px 0','name':'Northern Ireland'};
countryflags[94]={'flag':'-1880px 0','name':'Jamaica'};
countryflags[95]={'flag':'-1900px 0','name':'Kenya'};
countryflags[96]={'flag':'-1920px 0','name':'Panamá'};
countryflags[97]={'flag':'-1940px 0','name':'Makedonija'};
countryflags[98]={'flag':'-1960px 0','name':'Shqipëria'};
countryflags[99]={'flag':'-1980px 0','name':'Honduras'};


countryid_to_leagueid[1]=1;
countryid_to_leagueid[2]=2;
countryid_to_leagueid[3]=3;
countryid_to_leagueid[4]=4;
countryid_to_leagueid[5]=5;
countryid_to_leagueid[6]=6;
countryid_to_leagueid[7]=7;
countryid_to_leagueid[8]=8;
countryid_to_leagueid[9]=9;
countryid_to_leagueid[10]=11;
countryid_to_leagueid[11]=12;
countryid_to_leagueid[12]=14;
countryid_to_leagueid[13]=15;
countryid_to_leagueid[22]=16;
countryid_to_leagueid[14]=17;
countryid_to_leagueid[17]=18;
countryid_to_leagueid[18]=19;
countryid_to_leagueid[27]=20;
countryid_to_leagueid[16]=21;
countryid_to_leagueid[25]=22;
countryid_to_leagueid[21]=23;
countryid_to_leagueid[26]=24;
countryid_to_leagueid[23]=25;
countryid_to_leagueid[15]=26;
countryid_to_leagueid[24]=27;
countryid_to_leagueid[19]=28;
countryid_to_leagueid[20]=29;
countryid_to_leagueid[29]=30;
countryid_to_leagueid[30]=31;
countryid_to_leagueid[31]=32;
countryid_to_leagueid[32]=33;
countryid_to_leagueid[28]=34;
countryid_to_leagueid[34]=35;
countryid_to_leagueid[35]=36;
countryid_to_leagueid[36]=37;
countryid_to_leagueid[37]=38;
countryid_to_leagueid[33]=39;
countryid_to_leagueid[38]=44;
countryid_to_leagueid[39]=45;
countryid_to_leagueid[40]=46;
countryid_to_leagueid[41]=47;
countryid_to_leagueid[45]=50;
countryid_to_leagueid[44]=51;
countryid_to_leagueid[46]=52;
countryid_to_leagueid[48]=53;
countryid_to_leagueid[49]=54;
countryid_to_leagueid[50]=55;
countryid_to_leagueid[47]=56;
countryid_to_leagueid[43]=57;
countryid_to_leagueid[42]=58;
countryid_to_leagueid[53]=59;
countryid_to_leagueid[52]=60;
countryid_to_leagueid[56]=61;
countryid_to_leagueid[55]=62;
countryid_to_leagueid[51]=63;
countryid_to_leagueid[57]=64;
countryid_to_leagueid[61]=66;
countryid_to_leagueid[66]=67;
countryid_to_leagueid[62]=68;
countryid_to_leagueid[63]=69;
countryid_to_leagueid[65]=70;
countryid_to_leagueid[64]=71;
countryid_to_leagueid[67]=72;
countryid_to_leagueid[68]=73;
countryid_to_leagueid[69]=74;
countryid_to_leagueid[70]=75;
countryid_to_leagueid[71]=76;
countryid_to_leagueid[72]=77;
countryid_to_leagueid[75]=79;
countryid_to_leagueid[76]=80;
countryid_to_leagueid[77]=81;
countryid_to_leagueid[78]=83;
countryid_to_leagueid[79]=84;
countryid_to_leagueid[80]=85;
countryid_to_leagueid[83]=88;
countryid_to_leagueid[82]=89;
countryid_to_leagueid[87]=91;
countryid_to_leagueid[88]=93;
countryid_to_leagueid[89]=94;
countryid_to_leagueid[90]=95;
countryid_to_leagueid[91]=96;
countryid_to_leagueid[92]=97;
countryid_to_leagueid[94]=98;
countryid_to_leagueid[95]=99;
countryid_to_leagueid[96]=100;
countryid_to_leagueid[97]=101;
countryid_to_leagueid[98]=102;
countryid_to_leagueid[99]=103;
countryid_to_leagueid[100]=104;
countryid_to_leagueid[101]=105;
countryid_to_leagueid[103]=106;
countryid_to_leagueid[102]=107;
countryid_to_leagueid[105]=110;
countryid_to_leagueid[121]=111;
countryid_to_leagueid[122]=112;
countryid_to_leagueid[123]=113;
countryid_to_leagueid[125]=117;
countryid_to_leagueid[126]=118;
countryid_to_leagueid[127]=119;
countryid_to_leagueid[128]=120;
countryid_to_leagueid[86]=121;
countryid_to_leagueid[104]=122;
countryid_to_leagueid[129]=123;
countryid_to_leagueid[130]=124;
countryid_to_leagueid[131]=125;
countryid_to_leagueid[132]=126;
countryid_to_leagueid[134]=127;
countryid_to_leagueid[135]=128;
countryid_to_leagueid[133]=129;
countryid_to_leagueid[137]=130;
countryid_to_leagueid[136]=131;
countryid_to_leagueid[138]=132;
countryid_to_leagueid[139]=133;
countryid_to_leagueid[140]=134;
countryid_to_leagueid[142]=135;
countryid_to_leagueid[143]=136;
countryid_to_leagueid[144]=137;
countryid_to_leagueid[145]=138;
countryid_to_leagueid[147]=139;
countryid_to_leagueid[148]=140;
countryid_to_leagueid[149]=141;
countryid_to_leagueid[150]=142;
countryid_to_leagueid[153]=143;
countryid_to_leagueid[154]=144;
