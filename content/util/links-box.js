...
Foxtrick.util.links = {
	...
	showEdit: function(doc , ownBoxBody, basepref) {
		try {
			...
			inputTitle.setAttribute('onfocus', "if (Foxtrick.util.links.value=='Title') " +
			                        "Foxtrick.util.links.value=''");
			...
			inputHref.setAttribute('onfocus', "if (Foxtrick.util.links.value=='http://example.org')"
									 + "Foxtrick.util.links.value='http://'");
